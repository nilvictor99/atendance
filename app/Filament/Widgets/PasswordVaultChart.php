...
class PasswordVaultChart extends AdvancedChartWidget
{
    use HasWidgetShield;

    public function getHeading(): string|Htmlable|null
    {
        return __('Saved Passwords');
    }
    ...
    public function getDescription(): ?string
    {
        ...
        return __('Number of passwords saved by period. Filtered: :range', ['range' => $dateRange]);
    }
            ...
            tooltip: {
                callbacks: {
                    label: function(context) {
                        return context.parsed.y + ' passwords';
                    }
                }
            }
        }
